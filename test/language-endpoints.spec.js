...
describe('Language Endpoints', function() {
  ...
  describe(`Endpoints protected by user`, () => {
    ...
    languageSpecificEndpoint.forEach(
      endpoint => {
  ...
  describe(`GET /api/language`, () => {
    const [
      usersLanguage
    ] = testLanguages.filter(
      lang =>
        lang.user_id === testUser.id
    );
      ...
      () => {
        ...
        it(`responds with incorrect and moves head`, () => {
          return supertest(app)
            ...
            .expect({
              nextWord:
                testLanguagesWords[1]
                  .original,
              totalScore: 0,
              wordCorrectCount: 0,
              wordIncorrectCount: 0,
              answer:
                testLanguagesWords[0]
                  .translation,
              isCorrect: false
            });
        });
