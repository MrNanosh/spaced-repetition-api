      ...
      it(`inserts 1 language with words for the new user`, () => {
        ...
        return supertest(app)
          ...
          .then(dbLists => {
            ...
            expect(
              dbLists[0].name
            ).to.eql(expectedList.name);
            expect(
              dbLists[0].total_score
            ).to.eql(0);
